...
@section('content')
                                ...
                                <th align='center' colspan="2">
                                    <div class="row">
                                        <div style="text-align:center">
                                            ...
                                            <button style="text-align:center; font-size:12px;" onclick="save();" disabled><i class="fa fa-save"></i></button>
                                        </div>
                                    </div>
                                </th>
                            </tr>
                                ...
                                @foreach ($empAttendances as $empAttendance)
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <button style="font-size:10px" onclick="edit(this, {{$index}})" disabled><i class="fa fa-pencil-square"></i></button>
                                        </td>
    ...
    <script type="text/javascript">
        ...
        function fetch_data(page, recs, sort_type, sort_by, query)
        {
            ...
            $('#fd_query').val(query);
            document.getElementById("searchfilter").action = '{{ route("emp_attendance.attendance_cond") }}?page=' + page;

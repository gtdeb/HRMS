                    ...
                    <table cellspacing="0" rules="all" border="1" id="Table1" style="border-collapse:collapse;" class="table table-hover table-bordered" >
                        <thead>
                            ...
                            <tr align='center'>
                                ...
                                <th width="14%" align='center' class="sorting" data-sorting_type="{{$pageSetting['sort_type']}}" data-column_name="indiv_hike_amt" style="cursor: pointer"> Indiv. Hike Amt. <span id="indiv_hike_amt_sort_icon"><i class="fa fa-sort" aria-hidden="true"></i></span></th>
                                <th width="14%" align='center' class="sorting" data-sorting_type="{{$pageSetting['sort_type']}}" data-column_name="loan_taken_amt" style="cursor: pointer"> Loan Taken Amt. <span id="loan_taken_amt_sort_icon"><i class="fa fa-sort" aria-hidden="true"></i></span></th>
                                <th width="14%" align='center' class="sorting" data-sorting_type="{{$pageSetting['sort_type']}}" data-column_name="loan_deducted_amt" style="cursor: pointer"> Loan Deducted Amt. <span id="loan_deducted_amt_sort_icon"><i class="fa fa-sort" aria-hidden="true"></i></span></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr align='center'>

                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                    if($user->admin == 1001){
                                        echo 'System';
                                    }elseif($user->admin == 1002){
                                        echo 'Admin';
                                    }elseif($user->admin == 1003){
                                        echo 'Employee';
                                    }
                                ?>
                            </td>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        {!! Form::model($users11, ['route' => ['admin.update', $users11->profile_id], 'method'=>'PUT']) !!}
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    {!! Html::linkRoute('admin.index', 'Cancel', array($users11->profile_id), array('class' => 'btn btn-danger btn-block')) !!}
                                </div>
                                <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    {{ Form::open(array('route' => array('admin.destroy', $user->profile_id), 'method' => 'delete')) }}

                    ...
                    <table cellspacing="0" rules="all" border="1" id="Table1" style="border-collapse:collapse;" class="table table-hover table-bordered" >
                        <thead>
                            ...
                            <tr align='center'>
                                ...
                                <th width="10%" align='center' class="sorting" data-sorting_type="{{$pageSetting['sort_type']}}" data-column_name="id" style="cursor: pointer"> Sr <span id="id_sort_icon"><i class="fa fa-sort" aria-hidden="true"></i></span></th>
                                ...
                                <th width="30%" align='center' class="sorting" data-sorting_type="{{$pageSetting['sort_type']}}" data-column_name="description" style="cursor: pointer"> Description <span id="description_sort_icon"><i class="fa fa-sort" aria-hidden="true"></i></span></th>
                            ...
                            @if($departments)
                                ...
                                @foreach ($departments as $department)
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <td>{{ $department->id }}</td>
                                        <td><label class="lblname">{{$department->name}}</label></td>
                                        <td><label class="lblname">{{$department->description}}</label></td>
                                        <td>
                                            @php
                                                $in_use = 'No';
                                                if($department->in_use > 0){
                                                ...
                                                $in_use = $in_use . '(' . $department->in_use . ')';
                                            @endphp
                                            {{ $in_use }}
